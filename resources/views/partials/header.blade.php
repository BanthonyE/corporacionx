            ...
            <div class="top-search-div">
                <div class="top-social">
                    <ul>
                        ...
                        <li>
                            <div class="hvr-sweep-to-right"><a href="https://www.linkedin.com/company/srgit" title=""
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <nav class="navbar navbar-expand-sm navbar-left">
                    <ul class="nav navbar-nav">
                        ...
                        <li
                            class="nav-item dropdown @if (setAction('index-2') ) @endif{{setAction('index')}} {{setAction('index-3')}}">
                        ...
                        <li class="nav-item dropdown {{setAction('about')}} {{setAction('about-2')}}"> <a
                        ...
                        <li
                            class="nav-item dropdown {{setAction('services')}} {{setAction('services-2')}} {{setAction('service-details')}}">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                        ...
                        <li
                            class="nav-item dropdown {{setAction('projects')}} {{setAction('projects-2')}} {{setAction('projects-lightbox')}} {{setAction('projects-lightbox-description')}} {{setAction('project-details')}}">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ route('projects-lightbox-description') }}">Projects
                                    Lighbox
                                    Description</a>
                                <a class="dropdown-item" href="{{ route('project-details') }}">Projects Details</a>
                            </div>
                        </li>
                        <li
                            class="nav-item dropdown {{setAction('faq')}} {{setAction('privacy')}} {{setAction('page-not-found')}} {{setAction('support')}}">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                        ...
                        <li
                            class="nav-item dropdown {{setAction('blogs')}} {{setAction('blogs-grid-1')}} {{setAction('blogs-grid-2')}} {{setAction('blogs-3')}} {{setAction('blog-details')}} {{setAction('blog-details-2')}}">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                        ...
                        <li class="nav-item dropdown {{setAction('contact')}} {{setAction('contact-2')}}"> <a
                                class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
