...
<div class="content-section about-page-section">
    <div class="container">
        ...
        <div class="col-lg-6 col-md-12 no-padding">
            ...
            <div class="two-imgs">
                <div class="col-xs-6 no-padding-left"><img src="assets\imgs\misc-images\2.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-xs-6 no-padding-right"><img src="assets\imgs\misc-images\1.jpg" class="img-fluid"
                        alt=""></div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="services-icons">
                            <div class="col-xs-2 no-padding"><img src="assets\imgs\icons\icon-1.png" alt=""
                                    class="img-fluid"></div>
                            <div class="col-xs-10">
                                <h4>Safe Work</h4>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="services-icons">
                            <div class="col-xs-2 no-padding"><img src="assets\imgs\icons\icon-2.png" alt=""
                                    class="img-fluid"></div>
                            <div class="col-xs-10">
                                <h4>Good Planning</h4>
                                <p>Eiusmod tempor incididunt ut labore et dolore Ut
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="services-icons">
                            <div class="col-xs-2 no-padding"><img src="assets\imgs\icons\icon-3.png" alt=""
                                    class="img-fluid"></div>
                            <div class="col-xs-10">
                                <h4>Professionals</h4>
                                <p>Eiusmod tempor incididunt ut labore et dolore Ut
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="services-icons">
                            <div class="col-xs-2 no-padding"><img src="assets\imgs\icons\icon-4.png" alt=""
                                    class="img-fluid"></div>
                            <div class="col-xs-10">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="services-icons">
                            <div class="col-xs-2 no-padding"><img src="assets\imgs\icons\commercial.png" alt=""
                                    class="img-fluid"></div>
                            <div class="col-xs-10">
                                <h4>Commercial</h4>
                                <p>Eiusmod tempor incididunt ut labore et dolore Ut
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="services-icons">
                            <div class="col-xs-2 no-padding"><img src="assets\imgs\icons\school.png" alt=""
                                    class="img-fluid"></div>
                            <div class="col-xs-10">
                                <h4>Government</h4>
                                <p>Eiusmod tempor incididunt ut labore et dolore Ut
