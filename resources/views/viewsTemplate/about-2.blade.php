...
<div class="content-section about-page-section">
  <div class="container">
    ...
    <div class="col-lg-6 col-md-12">
      <div class="img-container"> <img src="assets\imgs\about\about.jpg" class="img-fluid" alt="">
    ...
    <div class="col-lg-6 col-md-12 no-padding">
      ...
      <div class="two-imgs">
        <div class="col-xs-6 no-padding-left"><img src="assets\imgs\misc-images\2.jpg" class="img-fluid" alt=""></div>
        <div class="col-xs-6 no-padding-right"><img src="assets\imgs\misc-images\1.jpg" class="img-fluid" alt=""></div>
      </div>
    </div>
    <div class="clearfix"></div>
  </div>
...
<div class="content-section about-what-we-do">
  <div class="container">
    ...
    <div class="col-lg-12">
      <div class="row">
        <p>Simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text Simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text </p>
      <div class="row">
