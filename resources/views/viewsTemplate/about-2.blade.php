            ...
            <div class="about-wrp">
                <div class="abt-bx">
                    ...
                    <div class="abt-us-2">
                        ...
                        <p>Maecenas faucibus mollis interdum. Duis mollis, est non commodo luctus, nisi erat porttitor
                            ligula, eget lacinia odio sem nec elit. Donec sed odio dui. Integer posuere erat a ante
                            venenatis dapibus posuere velit aliquet. Maecenas faucibus mollis interdum. Duis mollis, est
                            non </p>
                        <a class="brd-rd2" href="#" title="">Learn more</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-5 col-sm-12 col-lg-6">
                            <div class="pur-sec">
                                <div class="pur-sec-inr">
                                    ...
                                    <p>Donec sed odio dui. Vivamus sagittis lacus vel augue laoreet rutrum faucibus
                                        dolor auctor. Donec ullamcorper nulla non metus auctor fringilla.</p>
                        ...
                        <div class="row counter-div">
                            <div class="col-md-3 col-sm-6 col-lg-3">
                                <div class="fn-fct-bx">
                                    ...
                                    <span class='numscroller numscroller-big-bottom' data-slno='1' data-min='0'
                                        data-max='120' data-delay='.5' data-increment="1">157</span>
                                    <h4>Happy clients</h4>
                            ...
                            <div class="col-md-3 col-sm-6 col-lg-3">
                                <div class="fn-fct-bx">
                                    ...
                                    <span class='numscroller numscroller-big-bottom' data-slno='1' data-min='0'
                                        data-max='120' data-delay='.5' data-increment="1">49</span>
                            ...
                            <div class="col-md-3 col-sm-6 col-lg-3">
                                <div class="fn-fct-bx">
                                    ...
                                    <span class='numscroller numscroller-big-bottom' data-slno='1' data-min='0'
                                        data-max='120' data-delay='.5' data-increment="1">31</span>
                            ...
                            <div class="col-md-3 col-sm-6 col-lg-3">
                                <div class="fn-fct-bx">
                                    ...
                                    <span class='numscroller numscroller-big-bottom' data-slno='1' data-min='0'
                                        data-max='120' data-delay='.5' data-increment="1">53</span>
                            ...
                            <div class="team-bx style2 text-center">
                                <div class="team-thumb hrz brd-rd50">
                                    ...
                                    <div class="team-scl">
                                        ...
                                        <a class="brd-rd50" href="#" title="Google Plus" target="_blank"><i
                                                class="fa fa-google-plus"></i></a>
                                        <a class="brd-rd50" href="#" title="Twitter" target="_blank"><i
                                                class="fa fa-twitter"></i></a>
                                        <a class="brd-rd50" href="#" title="Linkedin" target="_blank"><i
    ...
    <div class="container">
        <div class="row position-relative">
            ...
            <div class="col-md-12 text-center">
                ...
                <a data-fancybox="" class="play-button"
