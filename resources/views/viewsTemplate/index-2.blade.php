...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
  <div class="container-fluid p-0">
    <div class="top-bg">
      <div class="container">
        <div class="row">
          <div class="col-md-6 oswald"> <a href="mailto:contact@srgit.com"><i class="mdi mdi-email"></i> contact@srgit.com</a> <i class="mdi mdi-cellphone ml-3"></i>123 456 7980</div>
  ...
  <div class="container position-relative">
    <div class="mx-auto2"> <a class="navbar-brand logo-mobile" href="index.html"><img src="assets\imgs\logo.png" alt="" title=""></a>
...
<a href="about.html" class="dropdown-item">About Us</a> 
              <a href="about-2.html" class="dropdown-item"> About Us V2</a>
            </div>
          </li>
          ...
          <li class="nav-item logo-desktop"> <a class="nav-link pt-3 pb-1 m-0" href="index.html"><img src="assets\imgs\logo.png" alt="" title=""></a> </li>
...
<header>
  <div id="carousel-1" class="carousel slide" data-ride="carousel">
    <div class="container position-relative">
      <div class="social-media"> <a href=""><i class="fab fa-facebook-f"></i></a> <a href=""><i class="fab fa-twitter"></i></a> <a href=""><i class="fab fa-instagram"></i></a> </div>
      <a data-toggle="modal" href="" data-target="#myModal" class="get-a-free-quote position-absolute">Get a Free Quote</a> </div>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active" style="background-image: url('assets/imgs/home/banner-1.jpg')">
        <div class="carousel-caption banner-text">
          ...
          <h3>Construction<br>
            Services</h3>
          <a href="#" class="btn btn-primary oswald">Learn More</a> </div>
      </div>
    ...
    <div class="row">
	   <div class="col-lg-4 col-md-12 mb-2">
        <div class="right-box position-relative">
          ...
          <a href="" class="text-uppercase oswald  d-inline">Read More</a> </div>
      </div>
      ...
      <div class="col-lg-8 col-md-12 mb-2">
        <div id="carousel-2" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active"> <img src="assets\imgs\home\left-img.jpg" alt="" title="" class="img-fluid rounded"> </div>
            <div class="carousel-item"> <img src="assets\imgs\home\left-img.jpg" alt="" title="" class="img-fluid rounded"> </div>
            <div class="carousel-item"> <img src="assets\imgs\home\left-img.jpg" alt="" title="" class="img-fluid rounded"> </div>
          </div>
          <!-- Left and right controls -->
          <a class="carousel-control-prev" href="#carousel-2" data-slide="prev"> <span class="carousel-control-prev-icon"></span> </a> <a class="carousel-control-next" href="#carousel-2" data-slide="next"> <span class="carousel-control-next-icon"></span> </a> </div>
      </div>
    </div>
  </div>
  <div class="row mb-5">
    <div class="col-md-4 text-css text-center"> <img src="assets\imgs\home\support.svg" alt="" title="" width="50">
      <h3 class="mt-3">Neque porro quisquam est qu.</h3>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit vehicula est eget felis vehicula imperdiet non lacus at quam gravida porta usce viverra consectetur turpis id lacinia dolor sit amet.</p>
      <p><a href="">Read More <i class='fas fa-long-arrow-alt-right'></i></a></p>
    </div>
    <div class="col-md-4 text-css text-center"> <img src="assets\imgs\home\work2.svg" alt="" title="" width="50">
      <h3 class="mt-3">Neque porro quisquam est qu.</h3>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit vehicula est eget felis vehicula imperdiet non lacus at quam gravida porta usce viverra consectetur turpis id lacinia dolor sit amet.</p>
      <p><a href="">Read More <i class='fas fa-long-arrow-alt-right'></i></a></p>
    </div>
    <div class="col-md-4 text-css text-center"> <img src="assets\imgs\home\construction.svg" alt="" title="" width="50">
      <h3 class="mt-3">Neque porro quisquam est qu.</h3>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit vehicula est eget felis vehicula imperdiet non lacus at quam gravida porta usce viverra consectetur turpis id lacinia dolor sit amet.</p>
      <p><a href="">Read More <i class='fas fa-long-arrow-alt-right'></i></a></p>
    </div>
...
<div class="bg-css">
  <div class="container video">
    <div class="text-center"> <a data-fancybox="" href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="btn text-white"><i class='fas fa-play'></i></a></div>
	   ...
	   <div class="col-md-6">
        <div class="right-img">
          <div class="img-2 position-relative rounded overflow-hidden">
            <div class="text-right"><img src="assets\imgs\home\img1.jpg" alt="" title="" class="w-100"></div>
            <div class="phone-n">
          ...
          <div class="progress ">
            <div class="progress-bar  wow animated progress-animated" style="width: 85%; height:6px;" role="progressbar"> <span class="sr-only">60% Complete</span> </div>
          </div>
          <h5 class="float-left"> SERVICES </h5>
          <span class="float-right oswald">30%</span>
          <div class="clearfix"></div>
          <div class="progress">
            <div class="progress-bar   wow animated progress-animated" style="width: 30%; height:6px;" role="progressbar"> <span class="sr-only">30% Complete</span> </div>
          </div>
          <h5 class="float-left"> CONSTRUCTION </h5>
          <span class="float-right oswald">60%</span>
          <div class="clearfix"></div>
          <div class="progress">
            <div class="progress-bar  wow animated progress-animated" style="width: 65%; height:6px;" role="progressbar"> <span class="sr-only">60% Complete</span> </div>
          </div>
        </div>
      </div>
    ...
    <div class="customers owl-carousel owl-theme">
      <div class="item">
        <div class="testimonails-box">
          <div class="mb-4"><img src="assets\imgs\home\customers-1.jpg" alt="" title="" class="rounded-circle"></div>
          <p class="oswald">Lorem Ipsum ist ein einfacher Demo-Text für die Print- und Schriftindustrie. Lorem Ipsum ist in der Industrie bereits der Standard Demo.</p>
          <h4> Sarah Albert <span>Director</span></h4>
          <img src="assets\imgs\home\quote.svg" alt="" title="" width="30"> </div>
      </div>
      <div class="item">
        <div class="testimonails-box">
          <div class="mb-4"><img src="assets\imgs\home\customers-2.jpg" alt="" title="" class="rounded-circle"></div>
          <p class="oswald">Lorem Ipsum ist ein einfacher Demo-Text für die Print- und Schriftindustrie. Lorem Ipsum ist in der Industrie bereits der Standard Demo.</p>
      ...
      <div class="item">
        <div class="testimonails-box">
          <div class="mb-4"><img src="assets\imgs\home\customers-3.jpg" alt="" title="" class="rounded-circle"></div>
          <p class="oswald">Lorem Ipsum ist ein einfacher Demo-Text für die Print- und Schriftindustrie. Lorem Ipsum ist in der Industrie bereits der Standard Demo.</p>
        ...
        <div class="well">
          <form method="post" id="subsForm" class="footer-subscribe montserrat text-center" onsubmit="return ajaxmailsubscribe();">
            <div class="input-group">
              ...
              <input type="email" class="btn btn-lg input-css" name="subsemail" id="subsemail" placeholder="Enter your Email here">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        ...
        <p class="footer-text"> Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci veliNeque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci veliNeque porro quisquam est qui.</p>
      </div>
      <div class="col-md-2">
        <h3>Company</h3>
        <ul>
  ...
  <div class="container-fluid copyright">
    <div class="container ">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="social-media2"> <a href=""><i class="fab fa-twitter"></i></a> <a href=""><i class="fab fa-facebook-f"></i></a> <a href=""><i class="fab fa-instagram"></i></a> <a href=""><i class="fab fa-youtube"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="col-xs-12 col-md-12 right-section form-sec">
            ...
            <form action="/" method="post" id="requestForm">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control input w-100" placeholder="Name" name="name" id="name" type="text">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control input w-100" placeholder="Email" name="email" id="email" type="text">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
