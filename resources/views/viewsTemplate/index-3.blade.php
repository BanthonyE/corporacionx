      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <nav class="navbar navbar-expand-sm navbar-left">
          <ul class="nav navbar-nav">
            <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> Home </a>
              <div class="dropdown-menu"> 
			  <a href="index.html" class="dropdown-item">Home v1</a>
<a href="index-2.html" class="dropdown-item">Home v2</a>
<a href="index-3.html" class="dropdown-item">Home v3</a> 
			  <a href="../template-onepage/index.html" class="dropdown-item">One Page Template</a> </div>
            </li>
...
<header>
  <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="scroll-dwn"> <a class="page-scroll dwn" href="#about"> <img src="assets\imgs\scroll-dwn.png" class="arrow bounce" alt=""></a> </div>
    ...
    <div class="carousel-inner" role="listbox"> 
      ...
      <div class="carousel-item" style="background-image: url('assets/imgs/banner-slider/banner-3.jpg')">
        <div class="pattern"></div>
        <div class="carousel-caption">
          <h2>Welcome to <span>HOME BUILDER</span> CONSTRUCTION SERVICES</h2>
          <h1>dolorem ipsum quia</h1>
...
<div class="content-section about-section about-home"> <span id="main-content" class="hotspot hotspot-subscribe"></span>
  <div class="container">
    ...
    <div class="col-xs-8">
      <div class="col-xs-5 text-uppercase fancy-txt montserrat wow fadeInLeft" data-wow-duration="900ms" data-wow-delay="200ms">We like build things with fun.</div>
      <div class="col-xs-7 top-txt wow fadeIn" data-wow-duration="900ms" data-wow-delay="400ms">
        <p>Lorem Ipsum ist ein einfacher Demo-Text für die Print- und Schriftindustrie. Lorem Ipsum ist in der Industrie bereits der Standard Demo-Text seit.</p>
        <p>Glauben oder nicht glauben, Lorem Ipsum ist nicht nur ein zufälliger Text. Er hat Wurzeln aus der Lateinischen Literatur von 45 v. Chr, was ihn über 2000 Jahre alt macht. Richar McClintock, ein Lateinprofessor des Hampden-Sydney College in Virgnia untersuche einige undeutliche Worte.</p>
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="col-xs-4 no-padding wow fadeInRight" data-wow-duration="900ms" data-wow-delay="600ms"><img src="assets\imgs\about\abt.png" alt="" class="img-responsive home-abt"></div>
    <div class="clearfix"></div>
  </div>
</div>
<!--\\ Content Section --> 
    ...
    <div class="tabs-left">
      <div class="col-xs-3 no-padding wow fadeInLeft" data-wow-duration="900ms" data-wow-delay="200ms">
        <ul class="nav nav-tabs">
          <li class="nav-item"><a class="nav-link active" href="#a" data-toggle="tab"><span class="number-div"><i class="flaticon-engineer"></i></span><span class="tab-txt">General Contracting</span></a></li>
          <li class="nav-item"><a class="nav-link" href="#b" data-toggle="tab"><span class="number-div"><i class="flaticon-caution"></i></span> <span class="tab-txt">Construction Services</span></a></li>
          <li class="nav-item"><a class="nav-link" href="#c" data-toggle="tab"><span class="number-div"><i class="flaticon-paint"></i></span> <span class="tab-txt">Building Modeling</span></a></li>
          <li class="nav-item"><a class="nav-link" href="#d" data-toggle="tab"><span class="number-div"><i class="flaticon-settings"></i></span> <span class="tab-txt">Pre-construction</span></a></li>
          <li class="nav-item"><a class="nav-link" href="#e" data-toggle="tab"><span class="number-div"><i class="flaticon-transport"></i></span> <span class="tab-txt">Management</span></a></li>
        </ul>
      </div>
      <div class="col-xs-9 wow fadeInRight" data-wow-duration="900ms" data-wow-delay="400ms">
        <div class="tab-content">
          <div class="tab-pane active" id="a">
            <div class="col-xs-6 no-padding"><img src="assets\imgs\tab\tab.jpg" alt="" class="img-fluid"></div>
            <div class="col-xs-6">
          ...
          <div class="tab-pane" id="b">
            <div class="col-xs-6 no-padding"><img src="assets\imgs\tab\tab-2.jpg" alt="" class="img-fluid"></div>
            <div class="col-xs-6">
          ...
          <div class="tab-pane" id="c">
            <div class="col-xs-6 no-padding"><img src="assets\imgs\tab\tab-3.jpg" alt="" class="img-fluid"></div>
            <div class="col-xs-6">
          ...
          <div class="tab-pane" id="d">
            <div class="col-xs-6 no-padding"><img src="assets\imgs\tab\tab-4.jpg" alt="" class="img-fluid"></div>
            <div class="col-xs-6">
          ...
          <div class="tab-pane" id="e">
            <div class="col-xs-6 no-padding"><img src="assets\imgs\tab\tab-5.jpg" alt="" class="img-fluid"></div>
            <div class="col-xs-6">
              <h3>Management</h3>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since.</p>
              <div class="icon-listing">
...
<div class="content-section projects-section">
  ...
  <div class="container">
    ...
    <div class="col-xs-2 wow fadeIn" data-wow-duration="900ms" data-wow-delay="100ms">
      ...
      <div class="gamma-description montserrat"> <a href="project-details.html" class="full-link" title=""></a>
        <h3> <img src="assets\imgs\icons\search.png" alt=""> <span class="clearfix"></span> Neque porro quisquam </h3>
        <p>Design / Build</p>
      </div>
      <img src="assets\imgs\projects\project1.jpg" alt="" class="img-fluid"> </div>
    <div class="col-xs-2 wow fadeIn" data-wow-duration="900ms" data-wow-delay="150ms">
      <div class="gamma-description montserrat"><a href="project-details.html" class="full-link" title=""></a>
        <h3> <img src="assets\imgs\icons\search.png" alt=""> <span class="clearfix"></span> Neque porro quisquam </h3>
        <p>Design / Build</p>
      </div>
      <img src="assets\imgs\projects\project2.jpg" alt="" class="img-fluid"></div>
    ...
    <div class="col-xs-2 wow fadeIn" data-wow-duration="900ms" data-wow-delay="250ms">
      ...
      <img src="assets\imgs\projects\project4.jpg" alt="" class="img-fluid"> </div>
    <div class="col-xs-2 wow fadeIn" data-wow-duration="900ms" data-wow-delay="300ms">
      <div class="gamma-description montserrat"><a href="project-details.html" class="full-link" title=""></a>
        <h3> <img src="assets\imgs\icons\search.png" alt=""> <span class="clearfix"></span> Neque porro quisquam </h3>
        <p>Design / Build</p>
      </div>
      <img src="assets\imgs\projects\project5.jpg" alt="" class="img-fluid"></div>
    <div class="col-xs-4 wow fadeIn" data-wow-duration="900ms" data-wow-delay="500ms">
      <div class="gamma-description montserrat"><a href="project-details.html" class="full-link" title=""></a>
        <h3> <img src="assets\imgs\icons\search.png" alt=""> <span class="clearfix"></span> Neque porro quisquam </h3>
        <p>Design / Build</p>
      </div>
      <img src="assets\imgs\projects\project-6.jpg" alt="" class="img-fluid"> </div>
    <div class="col-xs-2 wow fadeIn" data-wow-duration="900ms" data-wow-delay="450ms">
      <div class="gamma-description montserrat"><a href="project-details.html" class="full-link" title=""></a>
        <h3> <img src="assets\imgs\icons\search.png" alt=""> <span class="clearfix"></span> Neque porro quisquam </h3>
        <p>Design / Build</p>
      </div>
      <img src="assets\imgs\projects\project8.jpg" alt="" class="img-fluid"></div>
    ...
    <div class="col-xs-4 wow fadeIn" data-wow-duration="900ms" data-wow-delay="350ms">
      ...
      <img src="assets\imgs\projects\project-10.jpg" alt="" class="img-fluid"> </div>
    <div class="clearfix"></div>
  </div>
  <div class="project-bottom wow fadeIn" data-wow-duration="900ms" data-wow-delay="550ms"> VIEW MORE WORKS DONE BY Us <a href="projects.html" class="montserrat">VIEW ALL PROJECTS <i class="fa fa-long-arrow-right" aria-hidden="true"></i> </a> </div>
</div>
<!--\\ Projects --> 
<!-- company certifications -->
<div class="content-section company-certification" id="set-7"> <img src="assets\imgs\services-right.jpg" class="img-responsive right-services" alt="">
  <div class="container">
    <h2 class="text-center text-uppercase">Company <span class="orange-txt">CERTIFICATIONS</span></h2>
    <div class="border-creative text-center"><img src="assets\imgs\borders\border.png" alt=""></div>
    <div class="row">
      <div class="col-xs-3 text-center">
        <div class="hi-icon-wrap hi-icon-effect-7 hi-icon-effect-7a wow fadeInUp" data-wow-duration="900ms" data-wow-delay="100ms">
          <div class="hi-icon"><img src="assets\imgs\circle-icons\contracting.png" class="img-1" alt=""><img src="assets\imgs\circle-icons\contracting-hover.png" class="img-2" alt=""></div>
        </div>
      ...
      <div class="col-xs-3 text-center">
        <div class="hi-icon-wrap hi-icon-effect-7 hi-icon-effect-7a wow fadeInUp" data-wow-duration="900ms" data-wow-delay="200ms">
          <div class="hi-icon"><img src="assets\imgs\circle-icons\building.png" class="img-1" alt=""><img src="assets\imgs\circle-icons\building-hover.png" class="img-2" alt=""></div>
        </div>
      ...
      <div class="col-xs-3 text-center">
        <div class="hi-icon-wrap hi-icon-effect-7 hi-icon-effect-7a wow fadeInUp" data-wow-duration="900ms" data-wow-delay="300ms">
          <div class="hi-icon"><img src="assets\imgs\circle-icons\design.png" class="img-1" alt=""><img src="assets\imgs\circle-icons\design-hover.png" class="img-2" alt=""></div>
        </div>
      ...
      <div class="col-xs-3 text-center">
        <div class="hi-icon-wrap hi-icon-effect-7 hi-icon-effect-7a wow fadeInUp" data-wow-duration="900ms" data-wow-delay="400ms">
          <div class="hi-icon"><img src="assets\imgs\circle-icons\services.png" class="img-1" alt=""><img src="assets\imgs\circle-icons\services-hover.png" class="img-2" alt=""></div>
        </div>
    ...
    <div class="owl-carousel owl-theme">
        ...
        <div class="">
          <div class="hexagon hexagon1">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background:url(assets/imgs/staff/staff-4.png) no-repeat;"></div>
            </div>
          </div>
      ...
      <div class="item">
        <div class="">
          <div class="hexagon hexagon1">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background:url(assets/imgs/staff/staff-1.png) no-repeat;"></div>
            </div>
          </div>
          <div class="staff-desc text-center">
            <h5>John Anderson</h5>
      ...
      <div class="item">
        <div class="">
          <div class="hexagon hexagon1">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background:url(assets/imgs/staff/staff-2.png) no-repeat;"></div>
            </div>
          </div>
          <div class="staff-desc text-center">
            <h5>Maria Smith</h5>
      ...
      <div class="item">
        <div class="">
          <div class="hexagon hexagon1">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background:url(assets/imgs/staff/staff-3.png) no-repeat;"></div>
            </div>
          </div>
          <div class="staff-desc text-center">
            <h5>Jim Lee</h5>
          ...
          <div class="grid cs-style-3">
            <div class="figure">
              <div class="overlay-div montserrat">
                <div class="linkss"><a href="blog-details.html"><span><i class="fa fa-search" aria-hidden="true"></i></span></a> </div>
              </div>
              ...
              <div class="figcaption">
                ...
                <div class="news-detls">
                  <ul class="no-margin no-padding montserrat">
                    ...
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 12 May, 2020</li>
                  </ul>
                </div>
                <div class="clearfix"></div>
              </div>
      ...
      <div class="carousel-inner" role="listbox"> 
        ...
        <div class="carousel-item active">
          <blockquote>
            <div class="row">
              <div class="col-xs-12">
                <div class="img-and-name"> <img src="assets\imgs\icons\quote.png" class="quote-icon img-fluid" alt=""> <img style="width: 100px;height:100px;" src="assets\imgs\clients\client-1.jpg" class="img-circle" alt="">
                  <div class="clearfix"></div>
                </div>
        ...
        <div class="carousel-item">
          <blockquote>
            <div class="row">
              <div class="col-xs-12">
                <div class="img-and-name"> <img src="assets\imgs\icons\quote.png" class="quote-icon img-fluid" alt=""> <img style="width: 100px;height:100px;" src="assets\imgs\clients\client-2.jpg" class="img-circle" alt="">
                  <div class="clearfix"></div>
                </div>
                <p class="quote-para">Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</p>
              </div>
        ...
        <div class="carousel-item">
          <blockquote>
            <div class="row">
              <div class="col-xs-12">
                <div class="img-and-name"> <img src="assets\imgs\icons\quote.png" class="quote-icon img-fluid" alt=""> <img style="width: 100px;height:100px;" src="assets\imgs\clients\client.jpg" class="img-circle" alt="">
                  <div class="clearfix"></div>
                </div>
                <p class="quote-para">Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</p>
              </div>
...
<!-- SnapWidget -->
  ...
  <div class="copyright">
    <div class="container">
      <div class="pull-left">
        <p>© 2020. Home Builder Construction Services</p>
      </div>
      <div class="pull-right">
