...
<body class="loading">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle"
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('index') }}" class="dropdown-item">Home v1</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu"> <a href="{{ route('about') }}" class="nav-link">About Us</a>
                                    <a href="{{ route('about-2') }}" class="nav-link">About Us V2</a> </div>
                            </li>
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown"
                                ...
                                <div class="dropdown-menu"> <a href="{{ route('services') }}"
                                    ...
                                    <a href="{{ route('services-2') }}" class="dropdown-item">Services V2</a> <a
                                        href="{{ route('service-details') }}" class="dropdown-item">Services Details</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown"
                                ...
                                <div class="dropdown-menu"> <a class="dropdown-item"
                                    ...
                                    <a class="dropdown-item" href="{{ route('projects-2') }}">Projects V2</a> <a
                                        class="dropdown-item" href="{{ route('projects-lightbox') }}">Projects
                                        Lighbox</a> <a class="dropdown-item"
                            ...
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown"
                                ...
                                <div class="dropdown-menu"> <a href="{{ route('coming-soon') }}"
                                        class="dropdown-item">Coming
                                        Soon</a> <a href="{{ route('page-not-found') }}" class="dropdown-item">Page Not
                                        Found</a>
                                    <a href="{{ route('faq') }}" class="dropdown-item">FAQ</a> <a
                            ...
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown"
                                ...
                                <div class="dropdown-menu"> <a class="dropdown-item"
                                        ...
                                        href="{{ route('blog-details-2') }}">Blog Details Left Sidebar</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown"
                                ...
                                <div class="dropdown-menu"> <a class="dropdown-item"
                                        ...
                                        1</a> <a class="dropdown-item" href="{{ route('contact-2') }}">Contact Us 2</a>
                                </div>
                            </li>
        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active"
                    style="background-image: url('assets/imgs/banner-slider/banner-1.jpg')">
    ...
    <div class="content-section about-section about-home"> <span id="main-content"
        ...
        <div class="container">
            ...
            <div class="col-xs-8">
                ...
                <div class="col-xs-7 top-txt wow fadeIn" data-wow-duration="900ms" data-wow-delay="400ms">
                    <p>Lorem Ipsum ist ein einfacher Demo-Text für die Print- und Schriftindustrie. Lorem Ipsum ist in
                        der Industrie bereits der Standard Demo-Text seit.</p>
                ...
                <div class="col-xs-3 no-padding wow fadeInLeft" data-wow-duration="900ms" data-wow-delay="200ms">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" href="#a" data-toggle="tab"><span
                                    class="number-div"><i class="flaticon-engineer"></i></span><span
                                    class="tab-txt">General Contracting</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="#b" data-toggle="tab"><span class="number-div"><i
                                        class="flaticon-caution"></i></span> <span class="tab-txt">Construction
                                    Services</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="#c" data-toggle="tab"><span class="number-div"><i
                                        class="flaticon-paint"></i></span> <span class="tab-txt">Building
                                    Modeling</span></a></li>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="icon-listing">
                                    <ul class="no-margin no-padding">
                                        ...
                                        <li>
                                            <div class="icon-cont"> <i class="fa fa-users" aria-hidden="true"></i>
                                            </div>
                                            <div class="icon-txt">
    ...
    <div class="content-section projects-section">
        ...
        <div class="project-bottom wow fadeIn" data-wow-duration="900ms" data-wow-delay="550ms"> VIEW MORE WORKS DONE BY
            Us <a href="{{ route('projects') }}" class="montserrat">VIEW ALL PROJECTS <i class="fa fa-long-arrow-right"
            ...
            <div class="row">
                <div class="col-xs-3 text-center">
                    ...
                    <div class="wow fadeInDown" data-wow-duration="900ms" data-wow-delay="150ms">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do... Audio, beds, Decor,
                            Motion, Music </p>
                    </div>
                </div>
    ...
    <!--\\ company certifications -->
    <!--subscribe -->
    <div class="content-section subscribe-section text-center"> <span id="subscribe-main"
            class="hotspot hotspot-subscribe"></span>
                        ...
                        <div class="hexagon hexagon1">
                            <div class="hexagon-in1">
                                <div class="hexagon-in2"
                                    style="background:url(assets/imgs/staff/staff-4.png) no-repeat;"></div>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="">
                        <div class="hexagon hexagon1">
                            <div class="hexagon-in1">
                                <div class="hexagon-in2"
                                    style="background:url(assets/imgs/staff/staff-1.png) no-repeat;"></div>
                            </div>
                        </div>
                        <div class="staff-desc text-center">
                            <h5>John Anderson</h5>
                ...
                <div class="item">
                    <div class="">
                        <div class="hexagon hexagon1">
                            <div class="hexagon-in1">
                                <div class="hexagon-in2"
                                    style="background:url(assets/imgs/staff/staff-2.png) no-repeat;"></div>
                            </div>
                        </div>
                        <div class="staff-desc text-center">
                            <h5>Maria Smith</h5>
                ...
                <div class="item">
                    <div class="">
                        <div class="hexagon hexagon1">
                            <div class="hexagon-in1">
                                <div class="hexagon-in2"
                                    style="background:url(assets/imgs/staff/staff-3.png) no-repeat;"></div>
                            </div>
                        </div>
                        <div class="staff-desc text-center">
                            <h5>Jim Lee</h5>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeIn" data-wow-duration="900ms" data-wow-delay="150ms">
                        ...
                        <div class="foot-content">
                            ...
                            <ul class="no-margin no-padding foot-social">
                                ...
                                <li><a href="https://twitter.com/srgit" target="_blank"><i
                                            class="fa fa-twitter"></i></a></li>
                                <li><a href="http://srgit.tumblr.com/" target="_blank"><i class="fa fa-tumblr"></i></a>
                                </li>
