...
<body>
<!--header -->
<div class="coming-soon-logo text-center"><a href="index.html" title=""><img src="assets\imgs\comin-soon\logo.png" alt=""></a></div>
<!-- // header -->
<!-- Slider Jquery -->
...
<div class="subscribe-coming raleway text-uppercase">
  ...
  <div class="subscribe-form">
    <form method="post" id="subsMiddleForm" onsubmit="return ajaxmailmiddlesubscribe();">
      <input type="email" class="coming-input" name="subsmiddleemail" id="subsmiddleemail" placeholder="Enter your Email Address">
...
<a href="https://plus.google.com/u/0/111241896454295946416" target="_blank"><i class="fa fa-google-plus"></i></a>
