...
<link href="assets\js\video\style.css" rel="stylesheet">
</head>
<!-- //  Head-->
<body>
<!--header -->
        ...
        <nav class="navbar navbar-expand-sm navbar-left">
          <ul class="nav navbar-nav">
            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> Home </a>
              <div class="dropdown-menu"> <a href="index.html" class="dropdown-item">Home v1</a> <a href="index-2.html" class="dropdown-item">Home v2</a> <a href="index-3.html" class="dropdown-item">Home v3</a> <a href="../template-onepage/index.html" class="dropdown-item">Home One Page</a> </div>
            </li>
...
<div class="content-section about-page-section">
    ...
    <div class="">
      ...
      <div class="">
        <div id="portfoliolist">
          ...
          <div class="portfolio card" data-cat="card">
            <div class="grid-2">
              <figure class="effect-jazz"> <img src="assets\imgs\portfolio\recent\item5.png" class="img-fluid" alt="img25">
                <figcaption>
                  <h2><i class="fa fa-search" aria-hidden="true">&nbsp;</i></h2>
                  <a href="project-details.html" title="Project Details">View more</a> </figcaption>
              </figure>
          ...
          <div class="portfolio app" data-cat="app">
            <div class="grid-2">
              <figure class="effect-jazz"> <img src="assets\imgs\portfolio\recent\item6.png" class="img-fluid" alt="img25">
                <figcaption>
                  <h2><i class="fa fa-search" aria-hidden="true">&nbsp;</i></h2>
                  <a href="project-details.html" title="Project Details">View more</a> </figcaption>
              </figure>
  ...
  <div class="video-wrapper text-center" style="overflow:hidden; height:300px; background:none">
    <div class="pattern"></div>
    <div id="background-video" class="background-video"> <img src="assets\js\video\placeholder.jpg" alt="" class="placeholder-image"> </div>
...
<script src="assets\js\video\jquery.youtubebackground.js"></script>
<script>
    jQuery(function($) {
