...
<div class="col-lg-6 col-md-12">
        ...
        <ul class="no-margin no-padding">
          <li><span class="orange-txt"><i class="fa fa-calendar" aria-hidden="true"></i> Date :</span> April 15, 2020 </li>
    ...
    <div class="row other-row">
      <div class="owl-carousel owl-theme">
        <div class="item">
          <div class="portfolio">
            <div class="grid-2">
              <figure class="effect-jazz"> <img src="assets\imgs\portfolio\recent\item3.png" class="img-fluid" alt="img25">
                <figcaption>
                  <h2><i class="fa fa-search" aria-hidden="true"></i></h2>
                  <a href="project-details.html" title="Project Details">View more</a> </figcaption>
              </figure>
              <div class="clearfix"></div>
        ...
        <div class="item">
          <div class="portfolio">
            <div class="grid-2">
              <figure class="effect-jazz"> <img src="assets\imgs\portfolio\recent\item1.png" class="img-fluid" alt="img25">
                <figcaption>
                  <h2><i class="fa fa-search" aria-hidden="true"></i></h2>
                  <a href="project-details.html" title="Project Details">View more</a> </figcaption>
              </figure>
        ...
        <div class="item">
          <div class="portfolio">
            <div class="grid-2">
              <figure class="effect-jazz"> <img src="assets\imgs\portfolio\recent\item2.png" class="img-fluid" alt="img25">
                <figcaption>
                  <h2><i class="fa fa-search" aria-hidden="true"></i></h2>
                  <a href="project-details.html" title="Project Details">View more</a> </figcaption>
              </figure>
        ...
        <div class="item">
          <div class="portfolio">
            <div class="grid-2">
              <figure class="effect-jazz"> <img src="assets\imgs\portfolio\recent\item4.png" class="img-fluid" alt="img25">
                <figcaption>
                  <h2><i class="fa fa-search" aria-hidden="true"></i></h2>
                  <a href="project-details.html" title="Project Details">View more</a> </figcaption>
              </figure>
