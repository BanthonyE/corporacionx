...
<div class="content-section services-main">
  <div class="container services-dtls">
    ...
    <div class="col-xs-3">
      <div class="tabs-left-services">
        <div class="no-padding">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#a" data-toggle="tab"><span class="number-div"><i class="flaticon-home"></i></span><span class="tab-txt">General Contracting</span></a></li>
            <li><a href="#b" data-toggle="tab"><span class="number-div"><i class="flaticon-mansion"></i></span> <span class="tab-txt">Construction Services</span></a></li>
            <li><a href="#c" data-toggle="tab"><span class="number-div"><i class="flaticon-money"></i></span> <span class="tab-txt">Building Modeling</span></a></li>
            <li><a href="#d" data-toggle="tab"><span class="number-div"><i class="flaticon-fence"></i></span> <span class="tab-txt">Pre-construction</span></a></li>
            <li><a href="#e" data-toggle="tab"><span class="number-div"><i class="flaticon-skyline"></i></span> <span class="tab-txt">Management</span></a></li>
          </ul>
        </div>
        <div class="clearfix"></div>
      </div>
      <div class="brochures">
        <h4>Our Brochures</h4>
        <p>Sed facilisis lorem in orci bibendum ullamcorper. Mauris vitae augue elementum, sodales nulla aales nulla a</p>
        <ul class="brochures-lists">
          <li> <a href="#">Download .PDF <span class="fa fa-file-pdf-o"></span></a> </li>
          <li> <a href="#">Download .Doc <span class="fa fa-file-text-o"></span></a> </li>
        </ul>
        <i class="icon icon-sheet"></i> </div>
    </div>
    <div class="col-xs-5">
      <div class="tab-content">
        <div class="tab-pane active" id="a">
          <div class="col-xs-12 services-details-content no-padding">
            <h3>General Contracting</h3>
            <p class="margin-30">Sed facilisis lorem in orci bibendum ullamcorper. Mauris vitae augue elementum, sodales nulla a, semper ligula. Nullam vel enim risus. Integer rhoncus hendrerit sem egestas porttitor. Integer et mi sed dolor eleifend pretium quis ut velit.les nulla a, semper ligula. </p>
            <h3>Planning</h3>
            <p class="margin-30">Sed facilisis lorem in orci bibendum ullamcorper. Mauris vitae augue elementum, sodales nulla a, semper ligula. Nullam vel enim risus. Integer rhoncus hendrerit sem egestas porttitor. Integer et mi sed dolor eleifend pretium quis ut velit.les nulla a, semper ligula. </p>
            <h3>Movers &amp; Repairing</h3>
            <p class="margin-10">Sed facilisis lorem in orci bibendum ullamcorper. Mauris vitae augue elementum, sodales nulla a, semper ligula. </p>
            <ul class="no-margin no-padding">
              <li>Praesent sem libero, luctus et quam iaculis.</li>
    ...
    <div class="col-xs-4">
      <div id="amazingslider-wrapper-1" style="display:block;position:relative;max-width:100%;margin:0px  0px;">
        <div id="amazingslider-1" style="display:block;position:relative;margin:0 ;">
          <ul class="amazingslider-slides" style="display:none;">
            <li><img src="assets\imgs\misc-images\5.jpg" alt=""> </li>
            <li><img src="assets\imgs\misc-images\6.jpg" alt=""> </li>
            <li><img src="assets\imgs\misc-images\3.jpg" alt=""> </li>
            <li><img src="assets\imgs\misc-images\4.jpg" alt=""> </li>
          </ul>
        </div>
      </div>
      <div class="accordion-box">
        <div id="accordion" class="accordion">
          <div class="card mb-0">
            <div class="card-header collapsed " data-toggle="collapse" href="#collapseOne"> <a class="card-title"> Lorem ipsum quia dolor </a> </div>
            <div id="collapseOne" class="card-body collapse show" data-parent="#accordion">
              <p>Sed facilisis lorem in orci bibendum ullamcorper. Mauris vitae augue elementum, sodales nulla a, semper ligula. Nullam vel enim risus. Integer rhoncus hendrerit sem egestas porttitor. Integer et mi sed dolor eleifend phendrerit sem egestas porttitor. Integer et mi sed dolor eleifend</p>
            </div>
            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"> <a class="card-title"> Neque porro quisquam est </a> </div>
            <div id="collapseTwo" class="card-body collapse" data-parent="#accordion">
              <p>Sed facilisis lorem in orci bibendum ullamcorper. Mauris vitae augue elementum, sodales nulla a, semper ligula. Nullam vel enim risus. Integer rhoncus hendrerit sem egestas porttitor. Integer et mi sed dolor eleifend phendrerit sem egestas porttitor. Integer et mi sed dolor eleifend</p>
            </div>
            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree"> <a class="card-title"> Lorem ipsum quia dolor</a> </div>
            <div id="collapseThree" class="collapse" data-parent="#accordion">
              <div class="card-body">Sed facilisis lorem in orci bibendum ullamcorper. Mauris vitae augue elementum, sodales nulla a, semper ligula. Nullam vel enim risus. Integer rhoncus hendrerit sem egestas porttitor. Integer et mi sed dolor eleifend phendrerit sem egestas porttitor. Integer et mi sed dolor eleifend</div>
            </div>
            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse4"> <a class="card-title"> Lorem ipsum quia dolor </a> </div>
...
<!-- Amazing-slider -->
<link rel="stylesheet" type="text/css" href="assets\js\amazing-slider-plugin\image-slider\image-slider.css">
<script src="assets\js\amazing-slider-plugin\image-slider\image-slider-jquery.js"></script> 
<script src="assets\js\amazing-slider-plugin\image-slider\image-slider.js"></script> 
<!-- scroll top --> 
