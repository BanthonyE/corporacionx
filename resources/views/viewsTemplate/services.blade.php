      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <nav class="navbar navbar-expand-sm navbar-left">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> Services </a>
