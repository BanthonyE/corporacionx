...
<a href="index-3.html" class="dropdown-item">Home v3</a> <a href="../template-onepage/index.html" class="dropdown-item">Home One Page</a> </div>
            ...
            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> About </a>
			  ...
			  <a href="about-2.html" class="nav-link">About Us V2</a>
            ...
            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> Services </a>
              <div class="dropdown-menu"> <a href="services.html" class="dropdown-item">Services</a> 
			   <a href="services-2.html" class="dropdown-item">Services V2</a> <a href="service-details.html" class="dropdown-item">Services Details</a> </div>
            </li>
            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> Projects </a>
              <div class="dropdown-menu"> <a class="dropdown-item" href="projects.html">Projects</a>
...
<a class="dropdown-item" href="project-details.html">Projects Details</a> </div>
            ...
            <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> Blog </a>
              <div class="dropdown-menu"> <a class="dropdown-item" href="blogs.html">Blogs</a>
<a class="dropdown-item" href="blogs-grid-1.html">Blogs Grid</a>
<a class="dropdown-item" href="blogs-grid-2.html">Blogs Grid V2</a>
<a class="dropdown-item" href="blogs-3.html">Blogs Left Sidebar</a> <a class="dropdown-item" href="blog-details.html">Blog Details</a>
<a class="dropdown-item" href="blog-details-2.html">Blog Details Left Sidebar</a> </div>
            </li>
...
<div class="dropdown-menu">
			  <a class="dropdown-item" href="contact.html">Contact Us 1</a>
<a class="dropdown-item" href="contact-2.html">Contact Us 2</a>
</div>
            </li>
  ...
  <div class="container">
      ...
      <div class="col-lg-8 col-md-12">
        <div class="blog-in">
          ...
          <div class="img-cont"><img src="assets\imgs\blog-images\blog-1.jpg" alt="" title="" class="img-fluid"></div>
          <div class="blog-text">
            ...
            <p>Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p>
            <div class="clearfix"></div>
<div class="row m-0">           
<div class="col-lg-5 col-md-5 no-padding-left padd-0 text-center"><img src="assets\imgs\blog-images\blog-in.jpg" class="img-fluid mt-15" alt=""> </div>
<div class="col-lg-7 col-md-7 padd-0">
  <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; est usus legentis in iis qui facit.</p>
          ...
          <div class="comment-section">
            <div class="dp-container"><img src="assets\imgs\clients\client-1.jpg" class="img-fluid" alt=""></div>
          ...
          <hr class="pro-hr">
          <div class="comment-section">
            <div class="dp-container"><img src="assets\imgs\clients\client-2.jpg" class="img-fluid" alt=""></div>
            <div class="main-comment">
          ...
          <div class="comment-section">
            ...
            <div class="reply-form no-margin no-background no-border no-padding">
               <form action="/" method="post" id="blogCommentForm">
                ...
                <div class="row">
                  <div class="col-xs-6">
                    <input type="text" name="comment_name" id="comment_name" class="form-group name-input" placeholder="Name">
                  </div>
                  <div class="col-xs-6 no-padding-left">
                    <input type="text" name="comment_email" id="comment_email" class="form-group name-input" placeholder="Email">
                  </div>
                  <div class="col-xs-12">
                    <textarea name="comment_message" id="comment_message" placeholder="Message"></textarea>
                  </div>
                  <div class="col-xs-12">
				   <button type="button" class="continue montserrat" value="SUBMIT" name="submitt" onclick="return ajaxmailcommentblog();">SUBMIT <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>

				  <!--<a href="blog-details.html" class="continue montserrat">SUBMIT <i class="fa fa-long-arrow-right" aria-hidden="true"></i> </a>--> </div>
                  <div class="clearfix"></div>
                </div>
              </form>
            </div>
        ...
        <div class="">
          ...
          <div class="blog-right-2 padding-left-15">
            ...
            <div class="blog-right">
              ...
              <div class="clearfix"></div>
              <div class="">
                <div class="col-md-5 col-sm-4 col-xs-4 no-padding"> <img src="assets\imgs\blog-images\a.jpg" class="img-fluid" alt=""> </div>
                ...
                <div class="clearfix"></div>
                <div class="col-md-5 col-sm-4 col-xs-4 no-padding"> <img src="assets\imgs\blog-images\b.jpg" class="img-fluid" alt=""> </div>
                <div class="col-md-7 col-sm-8 col-xs-8 no-padding-right"> <a href="blog-details.html">
                  <h4>Neque porro quisquam est qui dolorem</h4>
                  </a>
                  <p>March 31, 2020</p>
                ...
                <div class="clearfix"></div>
                <div class="col-md-5 col-sm-4 col-xs-4 no-padding"> <img src="assets\imgs\blog-images\c.jpg" class="img-fluid" alt=""> </div>
                <div class="col-md-7 col-sm-8 col-xs-8 no-padding-right"> <a href="blog-details.html">
                  <h4>Neque porro quisquam est qui dolorem</h4>
                  </a>
                  <p>March 31, 2020</p>
