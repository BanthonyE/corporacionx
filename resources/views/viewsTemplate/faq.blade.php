...
<div class="top-header">
  <div class="container">
    <div class="pull-left"><a href="" title="Home"><img src="assets\imgs\logo.png" class="logo1" title="" alt=""> </a></div>
...
<a href="index-3.html" class="dropdown-item">Home v3</a> <a href="../template-onepage/index.html" class="dropdown-item">Home One Page</a> </div>
            ...
            <li class="nav-item dropdown  active"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> Pages </a>
  ...
  <div class="modal-dialog"> 
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" id="quoteClose" class="close" data-dismiss="modal">&times;</button>
      </div>
    ...
    <div class="col-md-8 col-xs-12">
      <div class="accordion-box faq-box">
        <div id="accordion" class="accordion">
          <div class="card mb-0"> <a class="card-header collapsed " data-toggle="collapse" href="#collapseOne"> <span class="card-title"> Neque porro quisquam est lang erwiesene? </span> </a>
            <div id="collapseOne" class="card-body collapse show" data-parent="#accordion">
              <p>Es ist ein lang erwiesener Fakt, dass ein Leser vom Text abgelenkt wird, wenn er sich ein Layout ansieht. Der Punkt, Lorem Ipsum zu nutzen, ist, dass es mehr oder weniger die normale Anordnung von Buchstaben darstellt und somit nach lesbarer Sprache. Es ist ein lang erwiesener Fakt, dass ein Leser vom Text abgelenkt wird, wenn er sich ein Layout ansieht. Der Punkt, Lorem Ipsum zu nutzen, ist, dass es mehr oder weniger die normale Anordnung von Buchstaben darstellt und somit nach lesbarer Sprache </p>
            </div>
            <a class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"> <span class="card-title"> Qui dolorem ipsum quia dolor von Buchstaben? </span> </a>
            <div id="collapseTwo" class="card-body collapse" data-parent="#accordion">
              <p>Es ist ein lang erwiesener Fakt, dass ein Leser vom Text abgelenkt wird, wenn er sich ein Layout ansieht. Der Punkt, Lorem Ipsum zu nutzen, ist, dass es mehr oder weniger die normale Anordnung von Buchstaben darstellt und somit nach lesbarer Sprache. Es ist ein lang erwiesener Fakt, dass ein Leser vom Text abgelenkt wird, wenn er sich ein Layout ansieht. Der Punkt, Lorem Ipsum zu nutzen, ist, dass es mehr oder weniger die normale Anordnung von Buchstaben darstellt und somit nach lesbarer Sprache </p>
            </div>
            <a class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree"> <span class="card-title"> Consectetur, adipisci velit dass ein Lese? </span> </a>
            <div id="collapseThree" class="collapse" data-parent="#accordion">
              <div class="card-body">Es ist ein lang erwiesener Fakt, dass ein Leser vom Text abgelenkt wird, wenn er sich ein Layout ansieht. Der Punkt, Lorem Ipsum zu nutzen, ist, dass es mehr oder weniger die normale Anordnung von Buchstaben darstellt und somit nach lesbarer Sprache. Es ist ein lang erwiesener Fakt, dass ein Leser vom Text abgelenkt wird, wenn er sich ein Layout ansieht. Der Punkt, Lorem Ipsum zu nutzen, ist, dass es mehr oder weniger die normale Anordnung von Buchstaben darstellt und somit nach lesbarer Sprache </div>
            </div>
            <a class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse4"> <span class="card-title"> Consectetur, adipisci velit dass ein Lese? </span> </a>
            <div id="collapse4" class="collapse" data-parent="#accordion">
              <div class="card-body">Es ist ein lang erwiesener Fakt, dass ein Leser vom Text abgelenkt wird, wenn er sich ein Layout ansieht. Der Punkt, Lorem Ipsum zu nutzen, ist, dass es mehr oder weniger die normale Anordnung von Buchstaben darstellt und somit nach lesbarer Sprache. Es ist ein lang erwiesener Fakt, dass ein Leser vom Text abgelenkt wird, wenn er sich ein Layout ansieht. Der Punkt, Lorem Ipsum zu nutzen, ist, dass es mehr oder weniger die normale Anordnung von Buchstaben darstellt und somit nach lesbarer Sprache </div>
            </div>
            <a class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse5"> <span class="card-title"> Consectetur, adipisci velit dass ein Lese? </span> </a>
  ...
  <div class="row-2">
    <div class="container">
      <div class="col-xs-12 col-md-6 info left-section bg-blue">
        ...
        <div class="border"></div>
        <div class="description"> Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</div>
      ...
      <div class="col-xs-12 col-md-6 bg-dark info right-section form-sec">
        ...
        <form action="/" method="post" id="faqForm">
          <div class="form-group no-margin">
            ...
            <div class="controls col-xs-6 no-padding-right">
              <input class="form-control input" name="topic" id="faq_topic" placeholder="Topic" type="text">
            </div>
            <div class="clearfix"></div>
          </div>
          <div class="form-group no-margin">
            <div class="controls col-xs-6 no-padding-left">
              <input class="form-control input" name="country" id="faq_country" placeholder="Your Country" type="text">
            </div>
            <div class="controls col-xs-6 no-padding-right">
              <input class="form-control input" name="email" id="faq_email" placeholder="Email" type="text">
            </div>
            <div class="clearfix"></div>
          </div>
          <div class="form-group no-margin">
            <div class="controls">
              <textarea class="form-control textarea" name="question" id="faq_question" placeholder="Your Question"></textarea>
            </div>
          </div>
          <div class="form-group">
...
<script src="assets\js\owl-cst-carousel.js"></script> 
