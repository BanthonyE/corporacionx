...
<a href="index-3.html" class="dropdown-item">Home v3</a> <a href="../template-onepage/index.html" class="dropdown-item">Home One Page</a> </div>
            ...
            <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> Contact Us </a>
      ...
      <div class="cnt-info-wrp overlap50 remove-ext3">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-lg-4">
            <div class="cnt-inf-bx"> <i class="fa fa-phone"></i> <strong>Phone</strong> <span>+91 761-4031437</span> <span>+91 123-456-7890</span> </div>
          </div>
          <div class="col-md-4 col-sm-6 col-lg-4">
            <div class="cnt-inf-bx"> <i class="fa fa-map-marker"></i> <strong>Address</strong> <span>385 "Shubham" New Adarsh Colony near MR4 road, I/F Gajannan Park Jabalpur, (MP)</span> </div>
          </div>
          <div class="col-md-4 col-sm-6 col-lg-4">
            <div class="cnt-inf-bx"> <i class="fa fa-envelope-o"></i> <strong>Email</strong> <a href="mailto:contact@homemaker.com" title="">contact@homemaker.com</a> <a href="mailto:contact@srgit.com" title="">contact@srgit.com</a> </div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="cnt-frm-dta">
      <div class="row">
        <div class="col-md-4 col-sm-12 col-lg-4">
          <div class="cnt-inf">
            <h2>Get In Touch</h2>
            <p>Maecenas faucibus mollis interdum. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Donec sed odio dui. Integer posuere erat a ante venenatis dapibus posuere</p>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="col-xs-6 phone-div">
        ...
        <div class="col-xs-6 pull-right">
          ...
          <div class="nws-txt no-padding">
            <h5>Mail Us : </h5>
            <p><a href="mailto:homemaker@gmail.com">homemaker@gmail.com</a>, <br>
